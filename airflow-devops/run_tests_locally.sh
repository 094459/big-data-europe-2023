...
docker run -v /Users/ricsue/Projects/BigDataEU/airflow-devops/dags:/usr/local/airflow/dags -v /Users/ricsue/Projects/BigDataEU/airflow-devops/plugins:/usr/local/airflow/plugins -v /Users/ricsue/Projects/BigDataEU/airflow-devops/requirements:/usr/local/airflow/requirements -it amazon/mwaa-local:2_7 test-requirements || exit 1
